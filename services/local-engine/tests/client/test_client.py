...
class ClientTests(unittest.TestCase):
    ...
    def test_all_run_routes_and_runtime_validation(self):
        self.assertEqual(self.client.health(),{"status":"ok"});self.assertEqual(self.client.capabilities()["schema_version"],"1.0");self.assertEqual(self.client.capabilities()["version"],"0.1.0");self.assertIn("analysis_id",self.client.analyse(analysis()))
