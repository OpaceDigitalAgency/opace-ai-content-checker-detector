...
Before the repository is public, report security concerns through <https://opace.agency/tools/ai/content-integrity/support/>. After publication, use the repository's private security-advisory form when it is available. Include the affected version, a minimal content-free reproduction and the expected impact.
