...
.oacit-actions .oacit-primary{color:#fff;background:var(--orange-deep);border-color:var(--orange-press);box-shadow:inset 0 1px 0 rgb(255 255 255 / 22%),0 2px 4px rgb(15 17 21 / 14%),0 10px 22px -8px rgb(169 71 10 / 60%);transition:border-color .16s ease,box-shadow .16s ease,transform .16s ease}
