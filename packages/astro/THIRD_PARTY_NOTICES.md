...
Version 0.2.0 bundles the following exact runtime packages so the integration is dependency-closed. This notice does not imply endorsement by their authors.
