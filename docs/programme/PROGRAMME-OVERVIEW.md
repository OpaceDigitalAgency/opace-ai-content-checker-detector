...
**Still held.** WordPress 1.0.4 remains the sole current exact local ZIP: `implementation/dist/opace-ai-content-integrity-1.0.4.zip`, SHA-256 `084556a727022f23cd33e6b8111694fb6e447898d9c5b005b091d2057f8520ec`, not submitted to WordPress.org. The Chrome extension, the Astro integration, the CLI/SDK packages and the synthetic benchmark mechanics all remain tested local candidates against frozen G1/G2 inputs. No public GitHub repository, npm or PyPI release, Chrome Web Store listing or Astro catalogue entry exists.
