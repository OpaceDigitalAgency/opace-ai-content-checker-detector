...
At the shipped rule — the minimum-evidence pair, primary 0.9855 or second-highest 0.9763, under segments-v3 — measured through onnxruntime-web, the runtime that actually ships, over the whole fresh 5,558-document long-form corpus (922 AI documents from 13 current models; 4,636 human documents from Europe PMC, GOV.UK, CRS, Global Voices, Mongabay, SEC EDGAR and PERSUADE): **889/922 (96.4%) of AI documents detected, 90/4,636 (1.94%) of human documents falsely flagged**. The EU server route at the same pair reads 883/922 (95.8%) and 45/4,636 (0.97%). The corpus is not fully independent of training: 654 of the 922 AI documents are independent of every cycle-2 split and 268 are not, 168 of them in the training split. This paragraph previously named 0.984 as the live operating point, reported 90.3% at 1.34%, and called the corpus documents the model had never seen; 0.984 is retired and all three readings are withdrawn.
