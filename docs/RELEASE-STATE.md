...
WordPress 1.1.11 was built twice with identical cross-platform ZIP metadata and SHA-256 `d5aafa33ecbb0e411458d2d2fd18c1341d0a59fda3356008dcd44bb2bd417240`. Chrome 1.2.3 was rebuilt after the shared writing-rule correction with identical SHA-256 `f1aa497a009cff8073af3f218be8f0d045c63fd01515fb7b476968a283a4ec74`. These are test candidates, not published releases. Exact package paths are in the [submission manifest](../submission-prep/submission-manifest.json).
