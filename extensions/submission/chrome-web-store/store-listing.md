...
The trained model in the browser checker, measured on a fresh 5,558-document long-form corpus at the operating point that ships today: 883 of 922 machine-written documents detected (95.8%) on the EU server route and 889 of 922 (96.4%) in the browser, at 45 of 4,636 (0.97%) and 90 of 4,636 (1.94%) human false positives respectively. Every rate below names the flag point it was measured at, because a rate measured at one flag point does not describe another.

- Human fiction is the worst case: at the operating point that ships, 23 of 260 human stories are wrongly flagged on the server route (8.8%) and 26 of 260 in the browser (10.0%). A novelist checking their own writing has roughly a one in eleven chance of being told it looks machine-written. The earlier figure of 33 of 260, 12.69%, was measured at the retired 0.980 flag point and must not be placed beside the rows here. The model was deliberately never trained on human fiction, because no matched human fiction corpus existed and training on unmatched machine fiction would have taught it that fiction equals AI.
- Short text defeats it. Binned by the words a passage actually has, 29 of 172 passages of 100 to 199 words are detected (16.9%), rising to 193 of 228 at 300 to 399 words (84.6%). Short human text is far less affected: 22 of 4,368 human passages across nine sources were wrongly flagged, 0.5%. The figures published until 30 August 2026 as 67% at 200 words, 50% at 150 and 19% at 100 are withdrawn: they were scored at the retired 0.980 threshold, recorded no per-length AI denominator and were never re-measured on a shipping runtime.
