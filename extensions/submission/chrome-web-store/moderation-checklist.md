...
- [ ] Do not upload until the owner accepts this exact version and hash. The bundled package is the 1.1.1 development candidate, not an approved release.
- [ ] Dashboard reports Manifest V3, version 1.1.1 and no manifest error.
...
- [ ] All five 1280 x 800 screenshots show distinct genuine 1.1.1 states captured from the exact package, and remain legible at 640 x 400.
