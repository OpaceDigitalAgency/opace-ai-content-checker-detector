...
class ReportLayout {
  ...
  newPage(section = this.runningSection) {
    ...
    this.page.text('AI CONTENT INTEGRITY', textLeft, A4.height - 36, { weight: 'bold', size: 7.4, fill: HIGHLIGHT, characterSpacing: 1.1 });
...
function composeCheckerPdf(result, options = {}) {
  ...
  const document = new PdfDocument({
    ...
    subject: 'Complete AI content integrity result, evidence and run record',
