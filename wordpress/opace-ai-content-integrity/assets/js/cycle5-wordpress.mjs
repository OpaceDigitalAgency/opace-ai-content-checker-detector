...
export function buildWordPressPrimitiveResult(deterministic, sourceText, options = {}) {
	...
	return {
		...
		exports: {
			...
			report: { available: false, format: 'none', contains_content: false, explicit_user_action: true, complete_evidence: false, product_identity: 'Opace AI Content Integrity', support_destination: supportDestination }
		},
		abuse_controls: {
...
export function composeWordPressServerResult(primitive, payload, sourceText, options = {}) {
	...
	const result = {
		...
		exports: { ...primitive.exports, receipt: { ...primitive.exports.receipt, available: true, contains_content: false }, share: { available: true, contains_content: false, payload: share }, report: { available: true, format: 'pdf', contains_content: true, explicit_user_action: true, complete_evidence: true, product_identity: 'Opace AI Content Integrity', support_destination: supportDestination } },
