...
function renderCompleteCheckerHtml(result) {
  ...
  return `<!doctype html><html lang="en-GB"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src 'unsafe-inline'"><title>Opace AI Content Integrity evidence report</title><style>
...
<header class="mast"><div><p class="brand">Opace AI Content Integrity</p><h1>Evidence report</h1><p>Generated ${escape(generated)} UTC \xB7 Evidence, not guarantees.</p></div><div class="summary"><span>${assessed ? "Model score" : "Model status"}</span><strong>${escape(assessed ? ai.display_score : "\u2014")}</strong><span>${escape(level)}</span></div></header>
...
<details class="card machine" open><summary>Complete machine record</summary><pre>${json(result)}</pre></details><footer class="footer">Opace AI Content Integrity \xB7 Page <span class="page"></span></footer>
</main></body></html>
`;
}
export {
