...
final class ServiceRefusal {
	...
	private static function message_for( $code ) {
		$messages = array(
			'server_rate_limited'     => __( 'The EU analysis service is busy. Wait before trying again.', 'opace-ai-content-checker-detector' ),
			'service_pacing'          => __( 'The EU analysis service is spacing out requests just now.', 'opace-ai-content-checker-detector' ),
			'site_hourly_limit'       => __( 'This site has used its hourly share of the EU analysis service.', 'opace-ai-content-checker-detector' ),
			'site_daily_limit'        => __( 'This site has used its daily share of the EU analysis service.', 'opace-ai-content-checker-detector' ),
			'channel_floor_exhausted' => __( 'The share of the EU service reserved for WordPress sites is spent for now.', 'opace-ai-content-checker-detector' ),
			'shared_pool_exhausted'   => __( 'The shared EU allowance is spent for now.', 'opace-ai-content-checker-detector' ),
			'server_route_disabled'   => __( 'The EU analysis service is not accepting WordPress runs at the moment.', 'opace-ai-content-checker-detector' ),
			'server_unreachable'      => __( 'The EU analysis service could not be reached.', 'opace-ai-content-checker-detector' ),
			'server_refused'          => __( 'The EU analysis service did not accept this request.', 'opace-ai-content-checker-detector' ),
		);
