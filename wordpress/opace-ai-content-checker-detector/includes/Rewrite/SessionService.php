...
final class SessionService {
	...
	public function unavailable_candidate() {
		return new WP_Error( 'provider_not_configured', __( 'Rewrite generation is unavailable until an approved local or Hub route is configured.', 'opace-ai-content-checker-detector' ), array( 'status' => 409 ) );
	}

	public function unavailable_approval() {
		return new WP_Error( 'method_not_configured', __( 'There is no approved candidate to apply.', 'opace-ai-content-checker-detector' ), array( 'status' => 409 ) );
	}
}
