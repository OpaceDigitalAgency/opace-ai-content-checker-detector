...
= 1.1.12 =
Packaging only: the contract validation library ships as plugin code rather than a private Composer package. Checks, scores and reports are unchanged.
...
= 1.1.12 =
Packaging update with no functional change.
